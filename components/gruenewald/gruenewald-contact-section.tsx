        ...
        <div className="relative z-10 mt-10 grid md:grid-cols-[minmax(0,1.7fr)_minmax(15rem,1fr)]">
          <article aria-labelledby="myroslava-name" className="min-w-0 md:pr-8 lg:pr-10">
            ...
            <div className="mt-5 grid min-w-0 items-start gap-7 lg:grid-cols-[13.5rem_minmax(0,1fr)] lg:gap-x-10 lg:gap-y-0">
              ...
              <div className="mx-auto w-full max-w-[15rem] lg:col-start-1 lg:row-start-2 lg:mx-0">
                <h3
                  id="myroslava-name"
                  className="mt-5 whitespace-nowrap text-2xl font-semibold tracking-[-0.02em] text-[#272425]"
                >
                  Myroslava Golovach
                </h3>
              ...
              <address className="grid min-w-0 gap-3 not-italic lg:col-start-2 lg:row-start-1 lg:h-full lg:grid-rows-2">
                  <a
          ...
          <aside
            ...
            className="flex min-w-0 flex-col border-t border-slate-200 bg-gradient-to-b from-transparent via-slate-50/70 to-transparent px-6 pb-7 pt-7 md:border-l md:border-t-0 md:bg-none md:pl-8 md:pt-0 lg:pl-10"
          >
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#009CA6]">
            ...
            <h3 id="sven-name" className="mt-5 text-2xl font-semibold text-[#272425]">
              Sven Schulze
            </h3>
            <p className="mt-1 text-base font-semibold text-[#009CA6]">Projekt- &amp; Bauleiter</p>
          </aside>
        </div>
      </section>
    </SectionShell>
