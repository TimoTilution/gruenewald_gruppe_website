...
const companies: CompanyCard[] = [
  ...
  },
  {
    ...
    buttonLabel: "Zu HRW",
    cardTone:
      "md:col-start-1 xl:col-start-1 xl:translate-x-[calc(50%+0.75rem)]",
    isSupporting: true,
  },
  {
    href: "/verwaltung",
    ...
    cardTone:
      "md:col-start-2 xl:col-start-3 xl:-translate-x-[calc(50%+0.75rem)]",
    isSupporting: true,
  },
];
          ...
          {companies.map((company) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3
                  className={`font-semibold leading-[1.2] tracking-[-0.015em] text-white ${
                      isSupporting
