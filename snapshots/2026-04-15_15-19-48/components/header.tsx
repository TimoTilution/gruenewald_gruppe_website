  ...
  return (
    <header ref={headerRef} className="sticky top-0 z-50 w-full pt-3 sm:pt-4">
      <div className="content-shell">
        <div className="overflow-hidden rounded-[2rem] border border-white/15 bg-stone shadow-soft">
          <div className="border-b border-forest-900/10 px-4 sm:px-6 lg:px-8">
            <div
          ...
          <div className="bg-forest-800 px-4 sm:px-6 lg:px-8">
            <nav
              aria-label="Onepager"
