...
export function Header() {
  ...
  useLayoutEffect(() => {
    const updateMonogramPosition = () => {
      ...
      if (containerRect) {
        setMonogramLeft(containerRect.left * 0.9);
      }
    };
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/logos/gruenewald-monogram-cropped.png"
          alt="Grünewald Gruppe Monogramm"
          width={240}
          height={240}
          className="h-auto w-[7rem] drop-shadow-[0_20px_44px_rgba(14,25,55,0.24)] xl:w-[9rem]"
          priority
        />
      </Link>
    </header>
