        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          {heroActions.map((action) => (
            <Link
              key={action.href}
              href={action.href}
              className={`group flex flex-col rounded-[1.75rem] border border-white/25 px-6 py-4 text-center text-ink shadow-soft transition-all duration-200 hover:-translate-y-1 ${action.panelClassName}`}
            >
