  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex-1 text-center">
        <h3
          className="overflow-hidden text-[1.02rem] font-semibold leading-[1.2] tracking-[-0.015em] text-ink [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2] sm:text-[1.08rem] xl:text-[1.12rem]"
          title={title}
        >
          {title}
        </h3>
        <p
          className="mt-4 overflow-hidden text-[0.94rem] leading-7 text-forest-800/78 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:2] sm:text-[0.96rem]"
          title={text}
        >
          {text}
        </p>
